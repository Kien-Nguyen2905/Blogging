  ...
  return (
    ...
    >
      <input
        ...
        {...rest}
      />
      <div className="loading w-10 h-10 boder-8 border-green-500 rounded-full border-t-transparent animate-spin absolute z-10"></div>
      {!image ? (
        ...
        <Fragment>
          ...
          <button
            type="button"
            className="w-16 h-16 rounded-full absolute z-10 bg-white flex items-center justify-center"
            onClick={deleteImage}
          >
            <svg
