    ...
    >
      ...
      {!image ? (
        ...
        <Fragment>
          ...
          <button className="w-10 h-10 rounded-full absolute z-10 bg-white flex items-center justify-center">
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="w-6 h-6 flex items-center justify-center mr-0"
            >
              <path
                strokeLinecap="round"
